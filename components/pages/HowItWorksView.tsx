    ...
    <div className="space-y-12 w-full max-w-4xl mx-auto text-black">
      ...
      <div className="aura-card p-8 sm:p-12 bg-gradient-to-br from-white via-slate-50 to-amber-50/40 text-center space-y-4">
        ...
        <p className="text-sm sm:text-base text-slate-600 max-w-xl mx-auto font-normal leading-relaxed">
          AuraPool fixes what is broken with both traditional lotteries and public blockchains, creating a win-win savings account where your money stays safe forever.
        </p>
      </div>

      {/* 2. The Problems We Solve (Why We Built AuraPool) */}
      ...
      <div className="space-y-6">
        <div className="text-center max-w-xl mx-auto space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black text-black tracking-tight">
            The AuraPool Solution in 4 Simple Steps
          </h2>
      ...
      <div className="aura-card p-8 sm:p-10 bg-emerald-50/50 border border-emerald-200 text-xs space-y-4">
        ...
        <p className="text-emerald-900 leading-relaxed font-medium">
          In AuraPool, all prize money comes exclusively from external lending yield generated by the collective pool. Your deposited principal is never spent on tickets and never wagered. You can withdraw 100% of your original deposit at any time.
        </p>
