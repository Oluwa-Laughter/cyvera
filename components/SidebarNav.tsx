    ...
    <>
      ...
      `}>
        <div>
          ...
          {/* Slogan */}
          <div className="mt-4 px-3 py-2 rounded-2xl bg-slate-100 dark:bg-[#101524] border border-white/[0.08] text-[11px] text-[var(--muted)] flex items-center gap-2 font-medium">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? "bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 font-black shadow-[0_0_20px_rgba(6,182,212,0.35)]" 
                      : "text-[var(--muted)] hover:text-foreground hover:bg-slate-100 dark:hover:bg-[#111624]"}
                  `}
                >
                  ...
                  {item.badge && (
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold relative z-10 ${
                      isActive ? "bg-slate-950 text-cyan-300" : "bg-cyan-500/10 text-cyan-300 border border-cyan-500/20"
                    }`}>
                      {item.badge}
                    </span>
                  )}
        ...
        <div className="space-y-2.5 pt-6 border-t border-[var(--card-border)] text-xs">
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-between px-4 py-2.5 rounded-2xl bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 font-bold transition-all shadow-[0_0_15px_rgba(6,182,212,0.15)]"
          >
            <div className="flex items-center gap-2">
              <Droplets className="w-4 h-4 text-cyan-400" />
              <span>Get Free cUSDT / cUSDC</span>
            </div>
            <span className="text-[10px] bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 px-2 py-0.5 rounded-full font-black">+1000</span>
          </motion.button>
